...
std::vector<GemmTestParams> CreateTests2(
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_IGEMM_MINMAX_1X16C2__AVX2_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/2,
          /*adj_k_block=*/2,
          ...
          /*is_igemm=*/true,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_igemm_minmax_ukernel_1x16c2__avx2_broadcast,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_conv_goki_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_IGEMM_MINMAX_5X8C2__AVX2_BROADCAST, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/2,
          /*adj_k_block=*/2,
          /*mr=*/5, /*nr=*/8, /*kr=*/2, /*sr=*/1,
          /*is_igemm=*/true,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_igemm_minmax_ukernel_5x8c2__avx2_broadcast,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_conv_goki_w);
          },
          []() {
  ...
  INSTANTIATE_TEST_SUITE_P(
      F32_IGEMM_MINMAX_5X16C2__AVX2_BROADCAST_PRFM, GemmTest,
      testing::ValuesIn(CreateTests1(
          /*k_block=*/2,
          /*adj_k_block=*/2,
          ...
          /*is_igemm=*/true,
          [](GemmMicrokernelTester& tester) {
            tester.Test(xnn_f32_igemm_minmax_ukernel_5x16c2__avx2_broadcast_prfm,
                        xnn_init_f32_minmax_scalar_params,
                        xnn_pack_f32_conv_goki_w);
          },
          []() {
