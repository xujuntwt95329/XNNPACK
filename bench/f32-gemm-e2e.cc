...
BENCHMARK_FP32_END2END_JIT(f32_gemm_6x8_6x8__jit_aarch64_neonfma_cortex_a75_prfm);
  ...
  static void f32_gemm_5x16__fma3_prfm_broadcast(benchmark::State& state, models::ExecutionPlanFactory model) {
    GEMMEnd2EndBenchmark(state, model,
  ...
  BENCHMARK_FP32_END2END(f32_gemm_5x16__fma3_prfm_broadcast);
