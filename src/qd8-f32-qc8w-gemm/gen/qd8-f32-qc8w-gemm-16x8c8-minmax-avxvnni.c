...
void xnn_qd8_f32_qc8w_gemm_minmax_ukernel_16x8c8__avxvnni(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  const __m256i vinput_zero_point14 = _mm256_set1_epi32((int) quantization_params[14].zero_point);
  const __m256i vinput_zero_point15 = _mm256_set1_epi32((int) quantization_params[15].zero_point);
  ...
  do {
    ...
    __m256i vsum14x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point14);
    __m256i vacc14x0123 = _mm256_cvtepu32_epi64(_mm256_extracti128_si256(vsum14x01234567, 0));
    __m256i vacc14x4567 = _mm256_cvtepu32_epi64(_mm256_extracti128_si256(vsum14x01234567, 1));
    __m256i vsum15x01234567 = _mm256_mullo_epi32(vksum01234567, vinput_zero_point15);
    __m256i vacc15x0123 = _mm256_cvtepu32_epi64(_mm256_extracti128_si256(vsum15x01234567, 0));
    __m256i vacc15x4567 = _mm256_cvtepu32_epi64(_mm256_extracti128_si256(vsum15x01234567, 1));
    w = (const int32_t*) w + 8;
    ...
    while (k >= 16 * sizeof(int8_t)) {
      ...
      a13 += 16;
      const __m256i va14x01234567 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a14));
      const __m256i va14x89ABCDEF = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a14 + 8));
      a14 += 16;
      const __m256i va15x01234567 = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a15));
      const __m256i va15x89ABCDEF = _mm256_set1_epi64x((int64_t) unaligned_load_u64(a15 + 8));
      a15 += 16;
      ...
      vacc8x0123 = _mm256_dpbusd_avx_epi32(vacc8x0123, va8x01234567, vb01234567x0123);
      vacc8x4567 = _mm256_dpbusd_avx_epi32(vacc8x4567, va8x01234567, vb89ABCDEFx0123);
      vacc9x0123 = _mm256_dpbusd_avx_epi32(vacc9x0123, va9x01234567, vb01234567x0123);
      vacc9x4567 = _mm256_dpbusd_avx_epi32(vacc9x4567, va9x01234567, vb89ABCDEFx0123);
      vacc10x0123 = _mm256_dpbusd_avx_epi32(vacc10x0123, va10x01234567, vb01234567x0123);
      vacc10x4567 = _mm256_dpbusd_avx_epi32(vacc10x4567, va10x01234567, vb89ABCDEFx0123);
      vacc11x0123 = _mm256_dpbusd_avx_epi32(vacc11x0123, va11x01234567, vb01234567x0123);
      vacc11x4567 = _mm256_dpbusd_avx_epi32(vacc11x4567, va11x01234567, vb89ABCDEFx0123);
      vacc12x0123 = _mm256_dpbusd_avx_epi32(vacc12x0123, va12x01234567, vb01234567x0123);
      vacc12x4567 = _mm256_dpbusd_avx_epi32(vacc12x4567, va12x01234567, vb89ABCDEFx0123);
      vacc13x0123 = _mm256_dpbusd_avx_epi32(vacc13x0123, va13x01234567, vb01234567x0123);
      vacc13x4567 = _mm256_dpbusd_avx_epi32(vacc13x4567, va13x01234567, vb89ABCDEFx0123);
      vacc14x0123 = _mm256_dpbusd_avx_epi32(vacc14x0123, va14x01234567, vb01234567x0123);
      vacc14x4567 = _mm256_dpbusd_avx_epi32(vacc14x4567, va14x01234567, vb89ABCDEFx0123);
      vacc15x0123 = _mm256_dpbusd_avx_epi32(vacc15x0123, va15x01234567, vb01234567x0123);
      vacc15x4567 = _mm256_dpbusd_avx_epi32(vacc15x4567, va15x01234567, vb89ABCDEFx0123);
      ...
      vacc8x0123 = _mm256_dpbusd_avx_epi32(vacc8x0123, va8x89ABCDEF, vb01234567x4567);
      vacc8x4567 = _mm256_dpbusd_avx_epi32(vacc8x4567, va8x89ABCDEF, vb89ABCDEFx4567);
      vacc9x0123 = _mm256_dpbusd_avx_epi32(vacc9x0123, va9x89ABCDEF, vb01234567x4567);
      vacc9x4567 = _mm256_dpbusd_avx_epi32(vacc9x4567, va9x89ABCDEF, vb89ABCDEFx4567);
      vacc10x0123 = _mm256_dpbusd_avx_epi32(vacc10x0123, va10x89ABCDEF, vb01234567x4567);
      vacc10x4567 = _mm256_dpbusd_avx_epi32(vacc10x4567, va10x89ABCDEF, vb89ABCDEFx4567);
      vacc11x0123 = _mm256_dpbusd_avx_epi32(vacc11x0123, va11x89ABCDEF, vb01234567x4567);
      vacc11x4567 = _mm256_dpbusd_avx_epi32(vacc11x4567, va11x89ABCDEF, vb89ABCDEFx4567);
      vacc12x0123 = _mm256_dpbusd_avx_epi32(vacc12x0123, va12x89ABCDEF, vb01234567x4567);
      vacc12x4567 = _mm256_dpbusd_avx_epi32(vacc12x4567, va12x89ABCDEF, vb89ABCDEFx4567);
      vacc13x0123 = _mm256_dpbusd_avx_epi32(vacc13x0123, va13x89ABCDEF, vb01234567x4567);
      vacc13x4567 = _mm256_dpbusd_avx_epi32(vacc13x4567, va13x89ABCDEF, vb89ABCDEFx4567);
      vacc14x0123 = _mm256_dpbusd_avx_epi32(vacc14x0123, va14x89ABCDEF, vb01234567x4567);
      vacc14x4567 = _mm256_dpbusd_avx_epi32(vacc14x4567, va14x89ABCDEF, vb89ABCDEFx4567);
      vacc15x0123 = _mm256_dpbusd_avx_epi32(vacc15x0123, va15x89ABCDEF, vb01234567x4567);
      vacc15x4567 = _mm256_dpbusd_avx_epi32(vacc15x4567, va15x89ABCDEF, vb89ABCDEFx4567);
    ...
    const __m256i vsum14x02134657 = _mm256_hadd_epi32(vacc14x0123, vacc14x4567);
    __m256i vacc14x01234567 = _mm256_permute4x64_epi64(vsum14x02134657, _MM_SHUFFLE(3, 1, 2, 0));
    const __m256i vsum15x02134657 = _mm256_hadd_epi32(vacc15x0123, vacc15x4567);
    __m256i vacc15x01234567 = _mm256_permute4x64_epi64(vsum15x02134657, _MM_SHUFFLE(3, 1, 2, 0));
    ...
    __m256 vout14x01234567 = _mm256_cvtepi32_ps(vacc14x01234567);
    __m256 vout15x01234567 = _mm256_cvtepi32_ps(vacc15x01234567);
    ...
    vout14x01234567 = _mm256_mul_ps(vout14x01234567, _mm256_set1_ps(quantization_params[14].inv_scale));
    vout15x01234567 = _mm256_mul_ps(vout15x01234567, _mm256_set1_ps(quantization_params[15].inv_scale));
    ...
    vout14x01234567 = _mm256_fmadd_ps(vout14x01234567, vfilter_output_scale01234567, vbias01234567);
    vout15x01234567 = _mm256_fmadd_ps(vout15x01234567, vfilter_output_scale01234567, vbias01234567);
    ...
    vout14x01234567 = _mm256_max_ps(vout14x01234567, voutput_min);
    vout15x01234567 = _mm256_max_ps(vout15x01234567, voutput_min);
    ...
    vout14x01234567 = _mm256_min_ps(vout14x01234567, voutput_max);
    vout15x01234567 = _mm256_min_ps(vout15x01234567, voutput_max);
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      _mm256_storeu_ps(c14, vout14x01234567);
      a14 = (const int8_t*) ((uintptr_t) a14 - kc);
      c14 = (float*) ((uintptr_t) c14 + cn_stride);
      _mm256_storeu_ps(c15, vout15x01234567);
      ...
      __m128 vout8x0123 = _mm256_castps256_ps128(vout8x01234567);
      __m128 vout9x0123 = _mm256_castps256_ps128(vout9x01234567);
      __m128 vout10x0123 = _mm256_castps256_ps128(vout10x01234567);
      __m128 vout11x0123 = _mm256_castps256_ps128(vout11x01234567);
      __m128 vout12x0123 = _mm256_castps256_ps128(vout12x01234567);
      __m128 vout13x0123 = _mm256_castps256_ps128(vout13x01234567);
      __m128 vout14x0123 = _mm256_castps256_ps128(vout14x01234567);
      __m128 vout15x0123 = _mm256_castps256_ps128(vout15x01234567);
      if (nc & 4) {
        ...
        _mm_storeu_ps(c8, vout8x0123);
        c8 += 4;
        vout8x0123 = _mm256_extractf128_ps(vout8x01234567, 1);
        _mm_storeu_ps(c9, vout9x0123);
        c9 += 4;
        vout9x0123 = _mm256_extractf128_ps(vout9x01234567, 1);
        _mm_storeu_ps(c10, vout10x0123);
        c10 += 4;
        vout10x0123 = _mm256_extractf128_ps(vout10x01234567, 1);
        _mm_storeu_ps(c11, vout11x0123);
        c11 += 4;
        vout11x0123 = _mm256_extractf128_ps(vout11x01234567, 1);
        _mm_storeu_ps(c12, vout12x0123);
        c12 += 4;
        vout12x0123 = _mm256_extractf128_ps(vout12x01234567, 1);
        _mm_storeu_ps(c13, vout13x0123);
        c13 += 4;
        vout13x0123 = _mm256_extractf128_ps(vout13x01234567, 1);
        _mm_storeu_ps(c14, vout14x0123);
        c14 += 4;
        vout14x0123 = _mm256_extractf128_ps(vout14x01234567, 1);
        _mm_storeu_ps(c15, vout15x0123);
        c15 += 4;
        vout15x0123 = _mm256_extractf128_ps(vout15x01234567, 1);
      }
      if (nc & 2) {
        ...
        _mm_storel_pi((__m64*) c8, vout8x0123);
        c8 += 2;
        vout8x0123 = _mm_movehl_ps(vout8x0123, vout8x0123);
        _mm_storel_pi((__m64*) c9, vout9x0123);
        c9 += 2;
        vout9x0123 = _mm_movehl_ps(vout9x0123, vout9x0123);
        _mm_storel_pi((__m64*) c10, vout10x0123);
        c10 += 2;
        vout10x0123 = _mm_movehl_ps(vout10x0123, vout10x0123);
        _mm_storel_pi((__m64*) c11, vout11x0123);
        c11 += 2;
        vout11x0123 = _mm_movehl_ps(vout11x0123, vout11x0123);
        _mm_storel_pi((__m64*) c12, vout12x0123);
        c12 += 2;
        vout12x0123 = _mm_movehl_ps(vout12x0123, vout12x0123);
        _mm_storel_pi((__m64*) c13, vout13x0123);
        c13 += 2;
        vout13x0123 = _mm_movehl_ps(vout13x0123, vout13x0123);
        _mm_storel_pi((__m64*) c14, vout14x0123);
        c14 += 2;
        vout14x0123 = _mm_movehl_ps(vout14x0123, vout14x0123);
        _mm_storel_pi((__m64*) c15, vout15x0123);
        c15 += 2;
        vout15x0123 = _mm_movehl_ps(vout15x0123, vout15x0123);
      }
      if (nc & 1) {
        ...
        _mm_store_ss(c8, vout8x0123);
        _mm_store_ss(c9, vout9x0123);
        _mm_store_ss(c10, vout10x0123);
        _mm_store_ss(c11, vout11x0123);
        _mm_store_ss(c12, vout12x0123);
        _mm_store_ss(c13, vout13x0123);
        _mm_store_ss(c14, vout14x0123);
        _mm_store_ss(c15, vout15x0123);
      }
      nc = 0;
    }
  } while (nc != 0);
