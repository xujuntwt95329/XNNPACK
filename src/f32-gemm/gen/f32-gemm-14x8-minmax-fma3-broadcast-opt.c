...
void xnn_f32_gemm_minmax_ukernel_14x8__fma3_broadcast_opt(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    do {
      ...
      va = _mm256_broadcast_ss(a9);
      vacc9x01234567 = _mm256_fmadd_ps(va, vb01234567, vacc9x01234567);
      va = _mm256_broadcast_ss(a10);
      vacc10x01234567 = _mm256_fmadd_ps(va, vb01234567, vacc10x01234567);
      va = _mm256_broadcast_ss(a11);
      vacc11x01234567 = _mm256_fmadd_ps(va, vb01234567, vacc11x01234567);
      va = _mm256_broadcast_ss(a12);
      vacc12x01234567 = _mm256_fmadd_ps(va, vb01234567, vacc12x01234567);
      va = _mm256_broadcast_ss(a13);
      vacc13x01234567 = _mm256_fmadd_ps(va, vb01234567, vacc13x01234567);
