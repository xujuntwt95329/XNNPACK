...
void xnn_f32_gemm_minmax_ukernel_5x16__fma3_broadcast_opt(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    do {
      ...
      va0 = _mm256_broadcast_ss(a4);
      vacc4x01234567 = _mm256_fmadd_ps(va0, vb01234567, vacc4x01234567);      
      vacc4x89ABCDEF = _mm256_fmadd_ps(va0, vb89ABCDEF, vacc4x89ABCDEF);
