...
void xnn_qs8_packw_gemm_goi_ukernel_x8c8__sse2(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
  ...
  do {
    ...
    for (;n >= 8; n -= 8) {
      ...
      for (; k >= 8; k -= 8) {
        ...
        ksum0 += _mm_cvtsi128_si32(_mm_sad_epu8(v0, kzero));
        _mm_storel_epi64((__m128i *)&out[0], v0);
        w0 += 8;
        const __m128i v1 = _mm_loadl_epi64((const __m128i *)w1);
        ksum1 += _mm_cvtsi128_si32(_mm_sad_epu8(v1, kzero));
        _mm_storel_epi64((__m128i *)&out[8], v1);
        w1 += 8;
        const __m128i v2 = _mm_loadl_epi64((const __m128i *)w2);
        ksum2 += _mm_cvtsi128_si32(_mm_sad_epu8(v2, kzero));
        _mm_storel_epi64((__m128i *)&out[16], v2);
        w2 += 8;
        const __m128i v3 = _mm_loadl_epi64((const __m128i *)w3);
        ksum3 += _mm_cvtsi128_si32(_mm_sad_epu8(v3, kzero));
        _mm_storel_epi64((__m128i *)&out[24], v3);
        w3 += 8;
        const __m128i v4 = _mm_loadl_epi64((const __m128i *)w4);
        ksum4 += _mm_cvtsi128_si32(_mm_sad_epu8(v4, kzero));
        _mm_storel_epi64((__m128i *)&out[32], v4);
        w4 += 8;
        const __m128i v5 = _mm_loadl_epi64((const __m128i *)w5);
        ksum5 += _mm_cvtsi128_si32(_mm_sad_epu8(v5, kzero));
        _mm_storel_epi64((__m128i *)&out[40], v5);
        w5 += 8;
        const __m128i v6 = _mm_loadl_epi64((const __m128i *)w6);
        ksum6 += _mm_cvtsi128_si32(_mm_sad_epu8(v6, kzero));
        _mm_storel_epi64((__m128i *)&out[48], v6);
        w6 += 8;
        const __m128i v7 = _mm_loadl_epi64((const __m128i *)w7);
        ksum7 += _mm_cvtsi128_si32(_mm_sad_epu8(v7, kzero));
        _mm_storel_epi64((__m128i *)&out[56], v7);
        w7 += 8;
        out += 64;
      }
