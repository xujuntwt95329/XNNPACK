...
void xnn_f32_igemm_minmax_ukernel_5x8c2__avx2_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
  ...
  do {
    ...
    do {
      ...
      while (k >= 2 * sizeof(float)) {
        ...
        vacc1x4567c2 = _mm256_fmadd_ps(va1, vb1x0123c2, vacc1x4567c2);
        vacc2x0123c2 = _mm256_fmadd_ps(va2, vb0x0123c2, vacc2x0123c2);
        vacc2x4567c2 = _mm256_fmadd_ps(va2, vb1x0123c2, vacc2x4567c2);
        vacc3x0123c2 = _mm256_fmadd_ps(va3, vb0x0123c2, vacc3x0123c2);
        vacc3x4567c2 = _mm256_fmadd_ps(va3, vb1x0123c2, vacc3x4567c2);
        vacc4x0123c2 = _mm256_fmadd_ps(va4, vb0x0123c2, vacc4x0123c2);
        vacc4x4567c2 = _mm256_fmadd_ps(va4, vb1x0123c2, vacc4x4567c2);
