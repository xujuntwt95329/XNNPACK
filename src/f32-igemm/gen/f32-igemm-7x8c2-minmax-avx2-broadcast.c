...
void xnn_f32_igemm_minmax_ukernel_7x8c2__avx2_broadcast(
    size_t mr,
    size_t nc,
    size_t kc,
    size_t ks,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
      ...
      __m256 vacc6x0123c2 = vacc0x0123c2;
      __m256 vacc6x4567c2 = vacc0x4567c2;
      w += 8;
    ...
    do {
      ...
      while (k >= 2 * sizeof(float)) {
        ...
        a5 += 2;
        const __m256 va6 = _mm256_castsi256_ps(_mm256_set1_epi64x(*(int64_t *)a6));
        a6 += 2;
        ...
        vacc6x0123c2 = _mm256_fmadd_ps(va6, vb0x0123c2, vacc6x0123c2);
        vacc6x4567c2 = _mm256_fmadd_ps(va6, vb0x4567c2, vacc6x4567c2);
    ...
    __m256 vsum6x01452367 = _mm256_hadd_ps(vacc6x0123c2, vacc6x4567c2);
    ...
    __m256 vacc6x01234567 = _mm256_castpd_ps(_mm256_permute4x64_pd(_mm256_castps_pd(vsum6x01452367), _MM_SHUFFLE(3, 1, 2, 0)));
