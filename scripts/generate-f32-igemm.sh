...
tools/xngen src/f32-igemm/c2-avx-broadcast.c.in -D MR=6 -D NR=8  -D AVX=2 -D FMA=3 -D INC=0 -D DATATYPE=F32 -D PREFETCH=0 -o src/f32-igemm/gen/f32-igemm-6x8c2-minmax-avx2-broadcast.c &
tools/xngen src/f32-igemm/c2-avx-broadcast.c.in -D MR=7 -D NR=8  -D AVX=2 -D FMA=3 -D INC=0 -D DATATYPE=F32 -D PREFETCH=0 -o src/f32-igemm/gen/f32-igemm-7x8c2-minmax-avx2-broadcast.c &
